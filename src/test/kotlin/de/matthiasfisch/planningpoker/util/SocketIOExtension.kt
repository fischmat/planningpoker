...
class SocketIOExtension: AfterSpecListener, BeforeEachListener {
    ...
    fun joinGame(gameId: String, passwordHash: String? = null) {
        ...
        socket.emit(EnterGameCommand.EVENT_NAME, objectMapper.writeValueAsString(EnterGameCommand(gameId, passwordHash)))
